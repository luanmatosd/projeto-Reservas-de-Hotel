...
public class QuartoDeluxe extends Quarto {
    ...
    public QuartoDeluxe(String andar, String numero, double precoPorNoite) {
    ...
    public String exibeDetalhesDoQuarto() {
        return "Quarto Deluxe com cama king size, TV de 50 polegadas, minibar, e vista para o mar.";
    }
